...
ARCHITECTURE structure OF Prac1 IS
...
SIGNAL \ABorCD_andADorBD~0_combout\ : std_logic;
...
\ABorCD_andADorBD~0\ : cycloneiv_lcell_comb
-- Equation(s):
-- \ABorCD_andADorBD~0_combout\ = (\D~input_o\ & ((\B~input_o\) # ((\A~input_o\ & \C~input_o\))))
...
PORT MAP (
	...
	datac => \D~input_o\,
	datad => \B~input_o\,
	combout => \ABorCD_andADorBD~0_combout\);
